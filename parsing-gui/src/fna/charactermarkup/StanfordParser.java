...
public class StanfordParser implements Learn2Parse, SyntacticParser{
	...
	public StanfordParser(String posedfile, String parsedfile, String database, String tableprefix, String glosstable, boolean evaluation) {
		...
		try{
			...
			if(SetupDerbyDB.table_list.get((this.tableprefix+"_"+this.POSTaggedSentence).toLowerCase())==null)
			{
			stmt.execute("create table "+this.tableprefix+"_"+this.POSTaggedSentence+"(source varchar(100) NOT NULL, posedsent varchar(32660), PRIMARY KEY(source))");
			SetupDerbyDB.table_list.put((this.tableprefix+"_"+this.POSTaggedSentence).toLowerCase(), 1);
			}
